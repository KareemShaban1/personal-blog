        ...
        <main class="w-full flex-grow p-6">
            ...
            <div class="w-full mt-12">
                ...
                <div class="flex items-center justify-center mb-4">
                    ...
                    <form method="POST" action="{{ route('backend.account.update', $user->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
