                        ...
                        <tbody>
                            ...
                            <tr class="hover:bg-grey-lighter">
                                ...
                                <td class="py-4 px-6 border-b border-grey-light">
                                    ...
                                    <button class="px-4 py-1 text-white font-light tracking-wider bg-green-600 rounded" type="button"  onclick="location.href='{{ route('backend.user.edit', $user->id) }}';">Assign Role</button>
                                    <form type="submit" method="POST" style="display: inline" action="{{ route('backend.user.destroy', $user->id)}}" onsubmit="return confirm('Are you sure?')">
                                        @csrf
                                        @method('DELETE')
