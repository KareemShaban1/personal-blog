...
class TagController extends Controller
{
    ...
    public function store(StoreTagRequest $request)
    {
        ...
        return to_route('backend.tag.index')->with('message', 'Tag Created');
    }
    ...
    public function update(UpdateTagRequest $request, Tag $tag)
    {
        ...
        return to_route('backend.tag.index')->with('message', 'Tag Updated');
    }
    ...
    {
        $tag->delete();
        return to_route('backend.tag.index')->with('message', 'Tag Deleted !');
    }
}